...
const animationDetails = {
  ...
  Border: {
    ...
    keyframe:
      "@keyframes  border { 0% {   transform: rotate(0deg); } 100% {   transform: rotate(360deg); } }",
  },
  Blink: {
    description: "Blinks to bring attention",
    css: ".blink { content:''; height: 40px; width: 40px; border-radius: 50%; background: hotpink; animation: blinker 1s linear infinite; }",
  ...
  Bounce: {
    ...
    keyframe:
      "@keyframes bounce { 0% { transform: scale(1, 1) translateY(0); } 10% { transform: scale(1.1, 0.9) translateY(0); } 30% { transform: scale(0.9, 1.1) translateY(-100px); } 50% { transform: scale(1.05, 0.95) translateY(0); } 57% { transform: scale(1, 1) translateY(-7px); } 64% { transform: scale(1, 1) translateY(0); } 100% { transform: scale(1, 1) translateY(0); } }",
  },
  Breath: {
    ...
    keyframe:
      "@keyframes breath-animation {0% {background-color: lightgrey;   width: 100px;height: 100px;} 25% {background-color: lightblue;  width: 50px;height: 50px; }50% {background-color: lightgrey;   width: 100px;height: 100px;}50% {background-color: lightblue;  width: 50px;height: 50px; }100% {background-color: lightgrey;   width: 100px;height: 100px;} ",
  },
  FloatingBubble: {
    description: "Simulates a calming breath movement",
    ...
    keyframe:
      "@keyframes bubble { 0% {   transform: translateY(100vh) scale(0); } 100% {   transform: translateX(-10vh) scale(1); } }",
  },
  GlowingRingsOverlap: {
    ...
    keyframe:
      "@keyframes rotate { from {   transform: rotate(0deg); } to {   transform: rotate(360deg); }}, @keyframes rotate2 { from {   transform: rotate(360deg); }to {    transform: rotate(0deg);  } }",
  },
  Jiggle: {
    ...
    keyframe:
      "@keyframes jiggle {0% {  transform: scaleX(1);} 40% {  transform: scaleX(1.12) scaleY(0.75);} 55% {  transform: scaleX(0.85) scaleY(1);} 65% {  transform: scaleX(1.09) scaleY(0.85);} 75% {  transform: scaleX(0.9) scaleY(1);} 90% {  transform: scaleX(1.05) scaleY(0.95);} 100% {  transform: scaleX(1) scaleY(1);} }",
  },
  Pulse: {
    ...
    keyframe:
      "@keyframes stretch { 0% {   transform: scale(0.5); } 50% {   transform: scale(1); }  100% {   transform: scale(0.5); }}",
  },
  Spin: {
    description: "Rotates an image in a circle in a smooth transistion",
    css: "animation: arrow-spin infinite 5s linear;",
    keyframe:
      " @media (prefers-reduced-motion: no-preference) { .arrow { animation: arrow-spin infinite 5s linear; }} @keyframes arrow-spin { from { transform: rotate(360deg);}to {transform: rotate(0deg);}}' }",
  },
};
