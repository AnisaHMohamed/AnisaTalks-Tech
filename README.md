...
To view a live demo, [click here](https://AnisaHMohamed.github.io/AnisaTalks-Tech
...
When creating a new Gatsby site, the CLI allows you to specify a starter, in this case simply provide the URL for this repo. This can be accomplished by running the command ```gatsby new YOUR_BLOG_NAME https://github.com/AnisaHMohamed/AnisaTalks-Tech```
...
export default {
  ...
  social: {
    ...
    github: 'https://github.com/AnisaHMohamed/AnisaTalks-Tech',
...
<!-- Markdown snippet -->
[![Deploy to Netlify](https://www.netlify.com/img/deploy/button.svg)](https://app.netlify.com/start/deploy?repository=https://github.com/AnisaHMohamed/AnisaTalks-Tech)
